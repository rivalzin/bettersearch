...
public final class BetterSearchClient {
    ...
    private static void ensureCreativeOrder() {
        ...
        try {
            net.minecraft.core.NonNullList<ItemStack> todos = net.minecraft.core.NonNullList.create();
            net.minecraft.world.item.CreativeModeTab.TAB_SEARCH.fillItemList(todos);
            rememberCreativeOrder(todos);
    ...
    private static void refreshOpenSearch(Minecraft minecraft) {
        try {
            if (minecraft.screen instanceof com.rivalzin.bettersearch.mixin.CreativeScreenAccessor) {
                com.rivalzin.bettersearch.mixin.CreativeScreenAccessor open =
                        (com.rivalzin.bettersearch.mixin.CreativeScreenAccessor) minecraft.screen;
