...
public final class BetterSearchConfigScreen extends OptionRowsScreen implements GuiYesNoCallback {
        ...
        switch (tab) {
            ...
            case MATCHING: {
                ...
                addSlider("fuzzy_threshold", 0, EFFORT_STEPS, 1,
                        ...
                        v -> settings.fuzzyThreshold = FUZZY_LEVELS[MathHelper.clamp_int(v, 0, EFFORT_STEPS)],
                ...
                addSlider("cross_field_threshold", 0, EFFORT_STEPS, 1,
                        ...
                        v -> settings.crossFieldThreshold = CROSS_FIELD_LEVELS[MathHelper.clamp_int(v, 0, EFFORT_STEPS)],
